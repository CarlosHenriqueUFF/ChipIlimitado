...
<head>
    ...
    <title>Chip Ilimitado - Esqueça o Limite</title>
    ...
    <div class="navbar-fixed">
        <nav class="cyan">
            <div class="nav-wrapper">
                <h1 class="logo-wrapper"><a href="dashboard.php" class="brand-logo darken-1"></a> <span
                        class="logo-text">Chip Ilimitado</span></h1>
                <ul class="right hide-on-med-and-down">
                    ...
                    <li><a href="members.php"><i
                            class="mdi-social-person"></i></a>
    ...
    <div class="wrapper">
        ...
        <aside id="left-sidebar-nav">
            <ul id="slide-out" class="side-nav fixed leftside-navigation">
                ...
                <li class="bold">
                    <a href="cliente.php" class="waves-effect waves-cyan">
                        <i class="mdi-social-people"></i>Cliente
                    </a>
                </li>

                <li class="bold">
                    <a href="chip.php" class="waves-effect waves-cyan">
                        <i class="mdi-action-payment"></i>Chip
                    </a>
                </li>

                <li class="bold">
                    <a href="relatorio.php" class="waves-effect waves-cyan">
                        <i class="mdi-action-toc"></i>Relatório
                    </a>
                </li>

                <li class="bold">
                    <a href="members.php" class="waves-effect waves-cyan">
                        <i class="mdi-social-person"></i>Administradores
                    </a>
                </li>

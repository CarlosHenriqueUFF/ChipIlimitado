...
<footer class="footer">
    <div class="container">
        <span class="left span-padding grey-text text-lighten-4"> Copyright © 2019 <a class="grey-text text-lighten-4" href="https://www.freelancer.com/u/CarlosMalaba" target="_blank"> Developer</a> All rights reserved.</span>

        <span class="right span-padding grey-text text-lighten-4"> Design and Developed by <a class="grey-text text-lighten-4" href="https://www.99freelas.com.br/user/carlos-henrique-carvalho" target="_blank">Carlos Developer</a></span>
    </div>
</footer>
<!-- END FOOTER -->

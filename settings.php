                                    ...
                                    <div class="input-field col s12">
                                        ...
                                        <div class="row">
                                            <div class="input-field col s3">
                                                <b>User Agent</b>
                                                <br>
                                                <a>Insert the value your user-agent</a>
                                            </div>

                                            <div class="input-field col s9">
                                                <input type="text" name="user_agent" id="package_name" value="<?php echo $settings_row['user_agent'];?>" required />
                                        ...
                                        <div class="row">
                                            <div class="input-field col s3">
                                                <b>Ads Type</b>
                                                <br>
                                                <a>Choose your ads provider (Admob, StartApp, Appodeal)</a>
                                            </div>

                                            <div class="input-field col s9">
                                                <select name="ads_type" id="adstype">
                                                        <?php if ($settings_row['ads_type'] == 'ADMOB') { ?>
                                                            <option value="ADMOB" selected="selected">Admob</option>
                                                            <option value="STARTAPP">StartApp</option>
                                                            <option value="APPODEAL">AppoDeal</option>
                                                        <?php } else if ($settings_row['ads_type'] == 'STARTAPP') { ?>
                                                        ...
                                                        <?php } else {?>
                                                            <option value="ADMOB">Admob</option>
                                                            <option value="STARTAPP">StartApp</option>
                                                            <option value="APPODEAL" selected="selected">AppoDeal</option>
                                                        <?php } ?>
                                                </select>
